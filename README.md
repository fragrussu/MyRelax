...
* [`getT1VTR.py`](https://github.com/fragrussu/MyRelax/blob/master/myrelax/getT1VTR.py): to fit a mono-exponential variable spin echo repetition time model to magnitude MRI data for [T1 estimation](http://doi.org/10.1148/rg.2017160099);
